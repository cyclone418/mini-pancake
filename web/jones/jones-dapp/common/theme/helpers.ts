...
export const buttonHasIcon = ({ rightIcon, leftIcon, icon }: StyleFunctionProps): boolean =>
  rightIcon || leftIcon || icon;
...
export const getJonesColor = (theme: Dict) => {
  ...
  return {
    ...
    primaryMain,
    purpleLight: getColor(theme, "purple.300"),
    purplePrimary,
    ...
    primaryGradientReverse: getPrimaryGradientProperty(primaryMain, purplePrimary),
    warningDark: getColor(theme, "warning.600"),
  };
};
